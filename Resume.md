...
- **亿达信息技术有限公司， 大数据中心，Java开发工程师，2025.10~2026.4**
...
- **人力资源管理系统**<br>
  *基于 Spring+JSP+MyBatis+MYSQL+XXJOB+JUnit+Activiti*
  该项目是企业级一体化人力资源管理平台，覆盖组织架构、员工档案、招聘入职、考勤打卡、档案封存、流程发起、请假管理、假期核算、员工复职处理、权限管理等全模块业务，对员工信息统一管理，满足企业千人级员工的人力资源数字化管理需求，提升 HR 工作效率与数据准确性。
  - 负责组织架构管理、员工档案管理模块的全流程开发，实现部门层级维护、员工信息增删改查、档案附件上传、员工履历追溯等核心功能；**独立开发假期管理相关业务，实现请假类型维护、假期余额扣减、假期台账管理，设计年假自动计算规则，支持按司龄分段核算年假天数，处理入职当年按在职月份折算年假、离职时年假结算、年假结转清零等逻辑。**
  - 开发员工复职业务流程，支持复职人员档案复用、工号策略处理、历史履历合并、复职后司龄重新计算，联动年假、假期余额重新核算，复职记录归档留存，支持 HR 追溯员工多次入职 / 复职历史。
  - 使用 MyBatis 实现数据持久层开发，完成 MySQL 数据库的多表关联查询、批量数据操作，**优化考勤、假期余额、年假核算相关数据查询效率，支持批量假期数据计算与批量年假重算。**
  - 负责模块单元测试编写、代码评审，整理开发文档与接口文档，协助团队完成系统上线前的功能验证与问题修复；**编写年假计算、假期扣减、复职业务的 JUnit 单元测试用例，覆盖边界场景（入职月末复职、跨年度年假结转、假期超额度申请）。**
  - 基于 Activiti 实现审批节点流转、条件分支、会办 / 办理、驳回重审、流程撤销等核心功能，**对接请假流程、员工复职审批流程，审批通过后自动触发假期余额扣减、年假更新、员工档案状态变更；驳回时回滚假期数据，保证流程状态与假期核算数据一致性。**
