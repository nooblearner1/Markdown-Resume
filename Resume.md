...
- **人力资源管理系统**<br>
  *基于Spring+JSP+MyBatis+MYSQL+XXJOB+JUnit+Activiti*
  该项目是企业级一体化人力资源管理平台，覆盖组织架构、员工档案、招聘入职、考勤打卡、档案封存、权限管理等全模块业务对员工信息统一管理，满足企业千人级员工的人力资源数字化管理需求，提升HR工作效率与数据准确性。
  - 负责组织架构管理、员工档案管理模块的全流程开发，实现部门层级维护、员工信息增删改查、档案附件上传、员工履历追溯等核心功能。
  - 使用 MyBatis实现数据持久层开发，完成 MySQL 数据库的多表关联查询、批量数据操作,考勤相关数据查询效率。
  - 负责模块单元测试编写、代码评审，整理开发文档与接口文档，协助团队完成系统上线前的功能验证与问题修复。
  - 实现员工信息导入 / 导出、薪资表导出、考勤报表生成等功能，满足 HR 数据导出需求。
  - 基于 Activiti 实现审批节点流转、条件分支、会办 / 办理、驳回重审、流程撤销等核心功能，保证流程状态流转正确。
